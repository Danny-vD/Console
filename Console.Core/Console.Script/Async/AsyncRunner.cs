...
namespace Console.Script.Async
{
    /// <summary>
    ...
    public class AsyncRunner
    {
        ...
        /// </summary>
        [Property(ScriptSystemInitializer.SCRIPT_SYSTEM_NAMESPACE+".async.scope")]
        ...
        /// </summary>
        [Property(ScriptSystemInitializer.SCRIPT_SYSTEM_NAMESPACE + ".async.executionorder")]
        ...
        /// </summary>
        [Property(ScriptSystemInitializer.SCRIPT_SYSTEM_NAMESPACE + ".async.suborder")]
        ...
        public AsyncRunner GetCurrent()
        {
            ...
            if (ExecutionOrder == ScriptExecutionOrder.ParentFirst)
            {
                if (!ThisFinished)
                {
                    return this;
