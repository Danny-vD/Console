...
namespace Console.Persistence
{
    ...
    public class PropertyLoaderCommands
    {
        ...
        [Command(
            "load-properties",
            Namespace = PersistentPropertiesInitializer.PERSISTENT_PROPERTIES_NAMESPACE,
            HelpMessage = "Load a settings file"
        )]
        ...
        [Command(
            "save-properties",
            Namespace = PersistentPropertiesInitializer.PERSISTENT_PROPERTIES_NAMESPACE,
            HelpMessage = "Save all properties to file"
        )]
        ...
        [Command(
            "save-properties",
            Namespace = PersistentPropertiesInitializer.PERSISTENT_PROPERTIES_NAMESPACE,
            HelpMessage = "Save all properties to file that match a search term"
        )]
