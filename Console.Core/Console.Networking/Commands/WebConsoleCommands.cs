...
namespace Console.Networking.Commands
{
    public static class WebConsoleCommands
    {
        ...
        [Command("wget", "Downloads the Specified Web Resource")]
        private static void WGet(string url, string destination, [CommandFlag] bool overwrite)
        {
        ...
        [Command("run-url", "Runs a Script file from a Url")]
