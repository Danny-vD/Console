...
/// </summary>
namespace Console.Core.CommandSystem.Builder.BuiltIn.PropertyAutoFill
{
    /// <summary>
    ...
    public class PropertyAutoFillProvider : AutoFillProvider
    {
        ...
        public override bool CanFill(AbstractCommand cmd, int paramNum)
        {
            ...
            {
                return cmd.MetaData[paramNum - 1].Attributes
                          .Any(x => x is PropertyAutoFillAttribute); //Use offset by one because of command name
            }
