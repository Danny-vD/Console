...
/// </summary>
namespace Console.Core.CommandSystem.Builder.BuiltIn.BoolAutoFill
{
    /// <summary>
    ...
    public class BoolAutoFillProvider : AutoFillProvider
    {
        ...
        public override bool CanFill(AbstractCommand cmd, int paramNum)
        {
            ...
            {
                return cmd.MetaData[paramNum - 1].ParameterType == typeof(bool) &&
                       !cmd.MetaData[paramNum - 1].Attributes
                           .Any(x => x is CommandFlagAttribute); //Use offset by one because of command name
            }
